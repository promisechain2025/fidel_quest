          ...
          {tab === 'auto' && (
            <div className="flex flex-col items-center gap-3">
              <div className="flex items-center gap-3">
                ...
                <button type="button" onClick={() => setPlaying((p) => !p)} className={`chunk flex h-16 w-16 items-center justify-center rounded-full text-white ${FOCUS}`} style={{ background: 'var(--go-deep)', boxShadow: '0 5px 0 var(--go-deep)', '--chunk-depth': '5px', outlineColor: 'var(--focus)' }} aria-label={playing ? t('masterPause', 'Pause') : t('masterPlay', 'Play')}>
